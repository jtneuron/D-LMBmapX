...
def calculate_accuracy(predictions, targets):
    ...
    Args:
        predictions: Tensor of shape (batch, channel, height, width), representing the model predictions.
        targets: Tensor of shape (batch, channel, height, width), representing the ground truth targets.
...
def soft_cldice_f1(pred, target):
    ...
    clprecision = positive_intersection(cl_pred, target)
    precision = positive_intersection(pred, target)
    return clrecall[0], clprecision[0], recall[0], precision[0]
