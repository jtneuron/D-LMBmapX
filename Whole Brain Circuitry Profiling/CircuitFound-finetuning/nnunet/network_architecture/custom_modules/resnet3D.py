...
__all__ = [
    ...
    'ResNeXtBottleneck',
    'ResNeXt',
    'generate_ResNet_model',
    'generate_ResNeXt_model'
]
...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.in_planes = self.block_inplanes[0]
        ...
        self.fc = nn.Linear(self.block_inplanes[3] * block.expansion, n_classes)
    ...
    def forward(self, x):
        ...
        # x1.shape: torch.Size([1, 256, 32, 32, 32])
        # x2.shape: torch.Size([1, 512, 16, 16, 16])
        # x3.shape: torch.Size([1, 1024, 8, 8, 8])
        # x4.shape: torch.Size([1, 2048, 4, 4, 4])
