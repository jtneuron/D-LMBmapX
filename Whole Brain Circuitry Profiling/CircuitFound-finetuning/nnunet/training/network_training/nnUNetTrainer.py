...
from nnunet.training.dataloading.dataset_loading import load_dataset, DataLoader3D, DataLoader2D, unpack_dataset, CustomDataset
...
class nnUNetTrainer(NetworkTrainer):
    ...
    def initialize(self, training=True, force_load_plans=False):
        ...
        print("!!!!!!!!!!!!!!!!!!!!!! self.normalization_schemes {}".format(self.normalization_schemes))
