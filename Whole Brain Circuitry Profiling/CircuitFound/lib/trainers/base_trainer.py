...
class BaseTrainer(object):
    ...
    def adjust_learning_rate(self, epoch, args):
        ...
        if epoch < args.warmup_epochs:
            ...
            # cur_lr = init_lr * (1.0 - epoch / args.epochs) ** 0.9
...
#             if args.distributed:
#                 train_sampler = torch.myutils.data.distributed.DistributedSampler(train_dataset)
#             else:
#                 train_sampler = None

#             self.dataloader = torch.myutils.data.DataLoader(train_dataset,
