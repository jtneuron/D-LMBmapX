...
def modify_label_arr(arr, *tuples):
    ft = [x[0] for x in tuples]
    sd = [x[1] for x in tuples]
...
def main():
    ...
    for epoch in range(resume_epoch + 1, args.epoches + 1):
        run_train(args, model_1, model_2, optimizer_1, optimizer_2, train_dataloader, device, epoch, num_classes)
        # if epoch % args.val_interval == 0:
        #     run_val(args, model_1, model_2, val_dataloader, device, epoch, num_classes)
...
def run_train(args, model_1, model_2, optimizer_1, optimizer_2, train_dataloader, device, epoch, num_classes):
    model_1.train()
    model_2.train()
    ...
    for img_dict in tqdm(train_dataloader):
        ...
        # label1[label1 > 5] = 1
        # label2[label2 > 5] = 1
        # modify_label_arr(label1, (10, 1),        (6, 1), (7, 1), (9, 1), (11, 0))
        # modify_label_arr(label2, (10, 1),        (6, 1), (7, 1), (9, 1), (11, 0))
        ...
        for i in range(0, view_1_size, batch_size):
            ...
            warp_img1, warp_mask1 = train_one_view(args, model_1, optimizer_1, img1, img2, mask1, mask2, "view_1_")
        ...
        for i in range(0, view_2_size, batch_size):
            ...
            warp_img1, warp_mask1 = train_one_view(args, model_2, optimizer_2, img1, img2, mask1, mask2, "view_2_")
        ...
        for i in range(0, view_1_size, batch_size):
            ...
            warp_img1, warp_mask1 = train_one_view(args, model_1, optimizer_1, img1, img2, mask1, mask2, "view_1_consistency_", is_consistency=True)
        ...
        for i in range(0, view_2_size, batch_size):
            ...
            warp_img1, warp_mask1 = train_one_view(args, model_2, optimizer_2, img1, img2, mask1, mask2, "view_2_consistency_", is_consistency=True)
...
def train_one_view(args, model, optimizer, img1, img2, mask1, mask2, identifier, is_consistency=False):
    ...
    loss_dict = compute_loss(args, dvf_i, img1, img2, mask1, mask2, is_consistency)
    for key, value in loss_dict.items():
...
def run_val(args, model_1, model_2, val_dataloader, device, epoch, num_classes):
    model_1.eval()
    model_2.eval()
    batch_size = args.batch_size
    view_1_dim = args.view_1_dim
    ...
    with torch.no_grad():
        for img_dict in tqdm(val_dataloader):
            ...
            for i in range(0, view_1_size, batch_size):
                ...
                # modify_label_arr(mask1_with_main_label, (10, 1),        (6, 1), (7, 1), (9, 1), (11, 0))
                # modify_label_arr(mask2_with_main_label, (10, 1),        (6, 1), (7, 1), (9, 1), (11, 0))
