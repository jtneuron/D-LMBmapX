...
from lib.networks.vision_transformer import ViTBackbone
from lib.networks.resnet3D import ResNet
...
class ViT_Res_MLP(nn.Module):
    ...
    def __init__(self, encoder, decoder, args):
        ...
        self.resnet = ResNet(block=Bottleneck,
                             ...
                             n_input_channels=args.in_chans,
