...
def get_train_loader(args, batch_size, workers, train_transform=None):
    print("============>get_train_loader")
    train_ds = get_json_trainset(args,
                                 workers=workers,
                                 train_transform=train_transform)

    # train_sampler = Sampler (train_ds) if args.distributed else None
    train_sampler = torch.utils.data.distributed.DistributedSampler(train_ds) if args.distributed else None
...
def get_val_loader(args, batch_size, workers, val_transform=None):
    ...
    val_sampler = torch.utils.data.distributed.DistributedSampler(val_ds) if args.distributed else None
