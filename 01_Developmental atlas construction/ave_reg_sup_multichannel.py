...
def create_argparser():
    defaults = dict(
        view_1_dim=2,
        view_2_dim=4,
        data_dir="/media/user/phz/registration_3/datasets/data_config/P10_affine_25um.json",
        checkpoint="/media/user/phz/registration_3/output/P10_ave_25um/state000200.pt",
        batch_size=1,
        logdir="/media/user/phz/data/488/P10_temp/P10_affine_result_25um/P10_ave_25um_sift",
        gpu='0',
        registration_type=1,
        save_img=True
    )
