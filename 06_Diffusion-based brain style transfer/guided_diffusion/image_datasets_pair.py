...
class ImageDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        cond_image = get_cond_image(local_image, isTrain=self.isTrain, type=self.type)  # sobel_bargin
        # cond_image = get_cond_image_fda(local_image, 15)  # fda_bargin
        # cond_image = local_image  # origin_image
        ...
        if self.target_images is not None:
            ...
            imgs_list = [local_image, cond_image, target_image]
        else:
        ...
        if self.target_images is not None:
            local_image, cond_image, target_image = imgs_list
        else:
            local_image, cond_image = imgs_list

        out_dict = {"cond_image": cond_image, "original_image": local_image}
...
def load_val_data(
    ...
    print('sample number:', len(all_files))
    classes = None
    if class_cond:
        # Assume classes are the first part of the filename,
        # before an underscore.
